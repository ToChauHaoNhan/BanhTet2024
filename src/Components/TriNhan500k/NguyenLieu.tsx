            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
                <div className="flex flex-col items-center text-center text-white">
                    <img
                        src={Nep}
                        alt="Nếp"
                        className="rounded-full w-[200px] h-[200px] md:w-[250px] md:h-[250px] lg:w-[350px] lg:h-[350px] object-cover mb-5"
                    />
                    <p className="text-sm md:text-md lg:text-md">
                        Nếp sáp ngâm cốt dừa (ít à), màu lá dứa xay lọc nước - Có thể đổi màu tím (lá cẩm).<br /><br />
                        Nếp được xào dẻo trước khi nấu để bánh nhanh hơn, có nêm xíu nên ăn vừa miệng. Kiểu nấu này của dân Mỹ Tho.
                    </p>
                </div>
